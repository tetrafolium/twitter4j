...
/*package*/ class EntitiesParseUtil {
    ...
    /*package*/ static UserMentionEntity[] getUserMentions(final JSONObject entities) throws JSONException, TwitterException {
    ...
    /*package*/ static URLEntity[] getUrls(final JSONObject entities) throws JSONException, TwitterException {
    ...
    /*package*/ static HashtagEntity[] getHashtags(final JSONObject entities) throws JSONException, TwitterException {
    ...
    /*package*/ static SymbolEntity[] getSymbols(final JSONObject entities) throws JSONException, TwitterException {
    ...
    /*package*/ static MediaEntity[] getMedia(final JSONObject entities) throws JSONException, TwitterException {
