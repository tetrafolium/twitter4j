...
final class SiteStreamsImpl extends StatusStreamBase {
    ...
    /*package*/ SiteStreamsImpl(final Dispatcher dispatcher, final InputStream stream, final Configuration conf, final StreamController cs) throws IOException {
        super(dispatcher, stream, conf);
        this.cs = cs;
    }

    /*package*/ SiteStreamsImpl(final Dispatcher dispatcher, final HttpResponse response, final Configuration conf, final StreamController cs) throws IOException {
...
, asUser(target), asStatus(targetObject));
    ...
    @Override
    protected void onUserListMemberAddition(final JSONObject addedMember, final JSONObject owner, final JSONObject userList, final StreamListener[] listeners) throws TwitterException, JSONException {
        for (StreamListener listener : listeners) {
...
, asUser(owner), asUserList(userList));
    ...
    @Override
    protected void onUserListMemberDeletion(final JSONObject deletedMember, final JSONObject owner, final JSONObject userList, final StreamListener[] listeners) throws TwitterException, JSONException {
        for (StreamListener listener : listeners) {
...
, asUser(owner), asUserList(userList));
    ...
    @Override
    protected void onUserListSubscription(final JSONObject source, final JSONObject owner, final JSONObject userList, final StreamListener[] listeners) throws TwitterException, JSONException {
        for (StreamListener listener : listeners) {
...
, asUser(owner), asUserList(userList));
    ...
    @Override
    protected void onUserListUnsubscription(final JSONObject source, final JSONObject owner, final JSONObject userList, final StreamListener[] listeners) throws TwitterException, JSONException {
        for (StreamListener listener : listeners) {
...
, asUser(owner), asUserList(userList));
    ...
    @Override
    protected void onUserListCreation(final JSONObject source, final JSONObject userList, final StreamListener[] listeners) throws TwitterException, JSONException {
        for (StreamListener listener : listeners) {
...
, asUserList(userList));
    ...
    @Override
    protected void onUserListUpdated(final JSONObject source, final JSONObject userList, final StreamListener[] listeners) throws TwitterException, JSONException {
        for (StreamListener listener : listeners) {
...
, asUserList(userList));
    ...
    @Override
    protected void onUserListDestroyed(final JSONObject source, final JSONObject userList, final StreamListener[] listeners) throws TwitterException {
        for (StreamListener listener : listeners) {
